...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-purple-900 to-pink-800 px-6 py-16">
      ...
      >
        <h2 className="text-3xl font-bold text-center text-pink-400 mb-6">Login</h2>
        ...
        <p className="text-center text-sm text-white/60 mt-6">
          Don't have an account? <NavLink to="/register" className="text-pink-400 underline">Register</NavLink>
        </p>
      </motion.div>
    </div>
  )
